...
// ==============================================================
#ifndef __sobel_hls_dadd_64rcU__HH__
#define __sobel_hls_dadd_64rcU__HH__
#include "ACMP_dadd.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(sobel_hls_dadd_64rcU) {
    ...
    SC_CTOR(sobel_hls_dadd_64rcU):  ACMP_dadd_U ("ACMP_dadd_U") {
        ACMP_dadd_U.clk(clk);
