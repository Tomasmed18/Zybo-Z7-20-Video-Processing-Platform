...
AXIvideo2Mat::AXIvideo2Mat(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sc_trace(mVcdFile, tmp_38_reg_522, "tmp_38_reg_522");
    sc_trace(mVcdFile, tmp_39_reg_527, "tmp_39_reg_527");
...
void AXIvideo2Mat::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp1_stage0.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_i_fu_416_p2.read()) && esl_seteq<1,1,1>(ap_block_pp1_stage0_11001.read(), ap_const_boolean_0))) {
        tmp_38_reg_522 = ap_phi_mux_p_Val2_s_phi_fu_336_p4.read().range(15, 8);
        tmp_39_reg_527 = ap_phi_mux_p_Val2_s_phi_fu_336_p4.read().range(23, 16);
...
void AXIvideo2Mat::thread_exitcond_i_fu_416_p2() {
    exitcond_i_fu_416_p2 = (!t_V_5_reg_296.read().is_01() || !cols_V_reg_470.read().is_01())? sc_lv<1>(): sc_lv<1>(t_V_5_reg_296.read() == cols_V_reg_470.read());
}
...
void AXIvideo2Mat::thread_img_data_stream_1_V_din() {
    img_data_stream_1_V_din = tmp_38_reg_522.read();
}
...
void AXIvideo2Mat::thread_img_data_stream_2_V_din() {
    img_data_stream_2_V_din = tmp_39_reg_527.read();
}
