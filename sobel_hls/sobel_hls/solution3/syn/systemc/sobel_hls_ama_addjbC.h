...
// ==============================================================
#ifndef __sobel_hls_ama_addjbC__HH__
#define __sobel_hls_ama_addjbC__HH__
...
template<
    ...
    int din3_WIDTH,
    int dout_WIDTH>
SC_MODULE(sobel_hls_ama_addjbC) {
    ...
    SC_CTOR(sobel_hls_ama_addjbC):  simcore_ama_0_U ("simcore_ama_0_U") {
