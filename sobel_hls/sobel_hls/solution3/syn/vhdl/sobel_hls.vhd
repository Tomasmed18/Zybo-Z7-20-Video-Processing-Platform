...
architecture behav of sobel_hls is 
    ...
    "sobel_hls,hls_ip_2018_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=10.049000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=9,HLS_SYN_DSP=39,HLS_SYN_FF=6006,HLS_SYN_LUT=11816,HLS_VERSION=2018_3}";
    ...
    signal Block_proc_U0_img_5_rows_V_out_din : STD_LOGIC_VECTOR (11 downto 0);
    ...
    signal img_5_rows_V_c_dout : STD_LOGIC_VECTOR (11 downto 0);
    ...
    signal img_0_rows_V_c22_dout : STD_LOGIC_VECTOR (11 downto 0);
    ...
    signal img_5_rows_V_c24_dout : STD_LOGIC_VECTOR (11 downto 0);
    ...
    port (
        ...
        img_5_rows_V_out_din : OUT STD_LOGIC_VECTOR (11 downto 0);
...
begin
    ...
    img_5_rows_V_c_U : component fifo_w12_d7_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    img_0_rows_V_c22_U : component fifo_w12_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    img_5_rows_V_c24_U : component fifo_w12_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
