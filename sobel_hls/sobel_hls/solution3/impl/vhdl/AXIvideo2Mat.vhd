...
architecture behav of AXIvideo2Mat is 
    ...
    signal tmp_38_reg_522 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_39_reg_527 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond_i_fu_416_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp1_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0))) then
                tmp_38_reg_522 <= ap_phi_mux_p_Val2_s_phi_fu_336_p4(15 downto 8);
                tmp_39_reg_527 <= ap_phi_mux_p_Val2_s_phi_fu_336_p4(23 downto 16);
    ...
    INPUT_STREAM_TDATA_blk_n_assign_proc : process(AXI_video_strm_V_data_V_0_state, ap_CS_fsm_state2, ap_CS_fsm_pp1_stage0, ap_enable_reg_pp1_iter0, ap_block_pp1_stage0, exitcond_i_fu_416_p2, brmerge_i_fu_430_p2, ap_CS_fsm_state8, eol_2_i_reg_368)
    begin
    ...
    exitcond_i_fu_416_p2 <= "1" when (t_V_5_reg_296 = cols_V_reg_470) else "0";
    ...
    img_data_stream_1_V_din <= tmp_38_reg_522;
    ...
    img_data_stream_2_V_din <= tmp_39_reg_527;
