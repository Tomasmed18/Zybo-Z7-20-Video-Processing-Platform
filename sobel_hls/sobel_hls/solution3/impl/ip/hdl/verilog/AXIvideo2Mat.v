...
reg   [7:0] tmp_reg_517;
reg   [7:0] tmp_38_reg_522;
reg   [7:0] tmp_39_reg_527;
reg    ap_block_state8;
...
always @ (posedge ap_clk) begin
    if (((exitcond_i_fu_416_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        tmp_38_reg_522 <= {{ap_phi_mux_p_Val2_s_phi_fu_336_p4[15:8]}};
        tmp_39_reg_527 <= {{ap_phi_mux_p_Val2_s_phi_fu_336_p4[23:16]}};
...
assign exitcond_i_fu_416_p2 = ((t_V_5_reg_296 == cols_V_reg_470) ? 1'b1 : 1'b0);
...
assign img_data_stream_1_V_din = tmp_38_reg_522;

assign img_data_stream_2_V_din = tmp_39_reg_527;
