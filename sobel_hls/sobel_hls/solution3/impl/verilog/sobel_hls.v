...
(* CORE_GENERATION_INFO="sobel_hls,hls_ip_2018_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=10.049000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=9,HLS_SYN_DSP=39,HLS_SYN_FF=6006,HLS_SYN_LUT=11816,HLS_VERSION=2018_3}" *)
...
wire   [11:0] Block_proc_U0_img_5_rows_V_out_din;
...
wire   [11:0] img_0_rows_V_c22_dout;
...
wire   [11:0] img_5_rows_V_c24_dout;
...
fifo_w12_d7_A img_5_rows_V_c_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w12_d2_A img_0_rows_V_c22_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w12_d2_A img_5_rows_V_c24_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
