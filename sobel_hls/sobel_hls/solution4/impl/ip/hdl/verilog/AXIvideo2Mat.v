...
wire   [0:0] exitcond4_i_fu_409_p2;
...
reg   [7:0] tmp_reg_521;
reg   [7:0] tmp_37_reg_526;
reg   [7:0] tmp_38_reg_531;
reg    ap_block_state8;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((exitcond4_i_fu_409_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp1_stage0_subdone) & (1'b1 == ap_condition_pp1_exit_iter0_state5) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
            ap_enable_reg_pp1_iter0 <= 1'b0;
        end else if (((exitcond4_i_fu_409_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond_i_fu_420_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        tmp_37_reg_526 <= {{ap_phi_mux_p_Val2_s_phi_fu_340_p4[15:8]}};
        tmp_38_reg_531 <= {{ap_phi_mux_p_Val2_s_phi_fu_340_p4[23:16]}};
...
always @ (*) begin
    if (((exitcond4_i_fu_409_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
assign exitcond4_i_fu_409_p2 = ((t_V_reg_267 == rows_V_reg_469) ? 1'b1 : 1'b0);
...
assign img_data_stream_1_V_din = tmp_37_reg_526;

assign img_data_stream_2_V_din = tmp_38_reg_531;
