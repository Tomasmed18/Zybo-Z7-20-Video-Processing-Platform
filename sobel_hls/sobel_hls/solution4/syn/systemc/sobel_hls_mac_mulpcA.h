...
// ==============================================================
#ifndef __sobel_hls_mac_mulpcA__HH__
#define __sobel_hls_mac_mulpcA__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(sobel_hls_mac_mulpcA) {
    ...
    SC_CTOR(sobel_hls_mac_mulpcA):  simcore_mac_4_U ("simcore_mac_4_U") {
