...
// ==============================================================
#ifndef __sobel_hls_mac_mulqcK__HH__
#define __sobel_hls_mac_mulqcK__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(sobel_hls_mac_mulqcK) {
    ...
    SC_CTOR(sobel_hls_mac_mulqcK):  simcore_mac_5_U ("simcore_mac_5_U") {
